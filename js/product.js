...
const PRODUCTS = {
  drones: {
    title: "Сучасні дрони",
    description: "Розвідувальні, тактичні та ударні безпілотні системи",
    heroImage: "../image/product/bg-image-product.webp", // загальна картинка на фоні
    items: [
      {
        title: "Mark 4 Easy 7 inch",
        description: "FPV камікадзе. Це найпростіший з дронів, але він надійний і добре виконує свої завдання!",
        image: "./image/product/drones/mark4Easy7inch.webp",
        tag: "ударний",
        features: [
            "Розмір дрона: 7 дюймів",
            "Вага без АКБ: 450 г",
            "Частота зв'язку: 915 MHz",
            "Тип підключення (протокол): ExpressLRS",
            "Рекомендована дальність польоту*: До 7 км",
            "Максимальна можлива дальність польоту**: До 20 км",
            "Час польоту***: до 20 хв",
            "Вантажопідйомність: До 1,6 кг",
            "Потужність відео каналу: 1,6 W",
            "Частота відео-звʼязку: 5,8 Ггц (може змінюватися на замовлення)",
            "Потужність каналу звʼязку та керування: 500 mW",
            "Тип камери: денна",
            "",
            "Технічні характеристики Mark 4 Easy 7 inch:",
            "Рама: RedytoSky Mark 4 7 inch 295 mm",
            "Політний контролер: YSIDO New F4 V3S PLUS 60A Stack FC + ESC (60A)",
            "Двигуни: Surpass або Angel A2807 1300 KV (4 штуки)",
            "Пропелери: HQProp Light Grey (2CW+2CCW) 7X4X3 (комплект)",
            "Камера: RunCam Robin або Vista Ratel 1200 TVL",
            "Відеопередавач: AKK Race Ranger 5,8 G-1.6 Watt",
            "Антена: Rush cherry Long range FPV 150 mm 5,8 Ghz SMA",
            "Радіоприймач: BetaFPV ELRS Nano Receiver 915 MHz nano"
        ],
        technicalSpecs: [
          { name: "Час польоту", value: "20 хв" },
          { name: "Дальність", value: "До 7 км" },
          { name: "Максимальна дальність", value: "До 20 км" },
          { name: "Вантажопідйомність", value: "До 1,6 кг" },
          { name: "Частота зв'язку", value: "915 MHz" },
          { name: "Тип підключення", value: "ExpressLRS" },
          { name: "Тип камери", value: "денна" },
        ],
        keyFeatures: [
          "Надійний і простий дизайн",
          "Легка вага та компактність",
          "Ефективна система управління",
          "Підтримка 5,8 Ггц відеозв’язку",
          "Висока стабільність польоту",
        ],
      },
      {
        title: "Mark 4 V2 10 inch Eagle eye",
        description: "FPV камікадзе. Це потужний дрон на топових запчастинах для знищення ворога",
        image: "./image/product/drones/mark4V210inchEagleeye.webp",
        tag: "розвідка",
        features: [
            "Розмір дрона: 10 дюймів",
            "Вага без АКБ: 950 г",
            "Частота зв'язку: 915 MHz",
            "Тип підключення (протокол): ExpressLRS",
            "Рекомендована дальність польоту*: До 10 км",
            "Максимальна можлива дальність польоту**: До 25 км",
            "Час польоту***: до 20 хв",
            "Вантажопідйомність: До 3 кг",
            "Потужність відео каналу: 3 W",
            "Частота відео-звʼязку (може змінюватися на замовлення): 5,8 Ггц",
            "Потужність каналу звʼязку та керування: 500 mW",
            "Тип камери: термальна, з двохосьовим стабілізатором, 256x192 FOV 19.6°×14.7°, T° 10°C~+50°C",
            "",
            "Технічні характеристики Mark 4 V2 10 inch Eagle eye:",
            "Рама: RedytoSky Mark 4 V2 10 inch 427 mm",
            "Політний контролер: Speedybee F405 V4 BLS 55A FC + ESC (55A)",
            "Двигуни: Flashhobby 3115 900 KV (4 штуки)",
            "Пропелери: HQProp Light Grey (2CW+2CCW) 10X5X3 (комплект)",
            "Камера термальна: PRC mini 256 CVBS 04010x, 256x192 FOV: 19.6°×14.7°, 10°C~+50°C",
            "Відеопередавач: AKK ULTRA LONG RANGE 5,8 GHz, 3 W",
            "Антена: Foxeer Pagoda PRO 150 mm 5,8 Ghz RPSMA",
            "Радіоприймач: BetaFPV ELRS 900 RX 915 MHz"
        ],
        technicalSpecs: [
          { name: "Час польоту", value: "20 хв" },
          { name: "Дальність", value: "До 10 км" },
          { name: "Максимальна дальність", value: "До 25 км" },
          { name: "Вантажопідйомність", value: "До 3 кг" },
          { name: "Частота зв'язку", value: "915 MHz" },
          { name: "Тип підключення", value: "ExpressLRS" },
          { name: "Тип камери", value: "термальна, з двохосьовим стабілізатором" },
        ],
        keyFeatures: [
          "Термальна камера з високою роздільною здатністю",
          "Покращена стабілізація польоту",
          "Велика дальність відеозв’язку",
          "Потужна система керування",
          "Надійний зв’язок на 915 MHz",
        ],
      },
      {
        title: "Mark 4 V2 10 inch Heavy Fury",
        description: "FPV бомбер. Це потужний дрон на топових запчастинах для скиду боєприпасів та розвідки",
        image: "./image/product/drones/mark4V210inchHeavyFury.webp",
        tag: "ударний",
        features: [
          "Розмір дрона: 10 дюймів",
            "Вага без АКБ: 900 г",
            ...
            "Тип камери: денна",
            "",
            "Технічні характеристики Mark 4 V2 10 inch Heavy Fury:",
            "Рама: RedytoSky Mark 4 V2 10 inch 427 mm",
            "Політний контролер: Speedybee F405 V4 BLS 50A FC + ESC (50A)",
            "Двигуни: Flashhobby Flashhobby 3115 900 KV (4 штуки)",
            "Пропелери: HQProp Light Grey (2CW+2CCW) 10X5X3 (комплект)",
            "Камера: RunCam Phoenix Special Edition 1000 TVL",
            "Відеопередавач: RushFpv TANK SOLO VTX 5,8 GHz, 1,6 W",
            "Антена: Foxeer Pagoda PRO 150 mm 5,8 Ghz RPSMA",
            "Радіоприймач: BetaFPV ELRS 900 RX 915 MHz"
        ],
        technicalSpecs: [
          ...
          { name: "Максимальна дальність", value: "До 25 км" },
          { name: "Вантажопідйомність", value: "До 3 кг" },
          { name: "Потужність відео каналу", value: "1,6 W" },
          { name: "Частота зв’язку", value: "915 MHz" },
          { name: "Тип камери", value: "денна" },
        ],
        keyFeatures: [
          "Потужна система скиду боєприпасів",
          "Надійна система зв’язку",
          "Висока вантажопідйомність",
          "Точна система керування польотом",
          "Стабільна робота в різних умовах",
        ],
      },
      {
        title: "Mark 4 V2 10 inch Long Range Bomber",
        description: "FPV нічний бомбер. Потужний дрон на топових запчастинах для ведення розвідки і скиду боєприпасів вночі. Висока надійність, довга автономність, передові технології управління",
        image: "./image/product/drones/mark4V210inchLongRangeBomber.webp",
        tag: "нічна розвідка",
        features: [
            "Розмір дрона: 10 дюймів",
            "Вага без АКБ: 925 г",
            ...
            "Час польоту***: до 20 хв",
            "Вантажопідйомність: До 3 кг",
            "Потужність відео каналу: 2,5 W",
            "Частота відео-звʼязку (може змінюватися на замовлення): 5,8 Ггц",
            "Потужність каналу звʼязку та керування: 500 mW",
            "Тип камери: денна, має поворотний механізм",
            "",
            "Технічні характеристики Mark 4 V2 10 inch Long Range Bomber:",
            "Рама: RedytoSky Mark 4 М2 10 inch 427 mm",
            "Політний контролер: Speedybee F405 V4 BLS 55A FC + ESC (55A)",
            "Двигуни: Flashhobby Flashhobby 3115 900 KV (4 штуки)",
            "Пропелери: HQProp Light Grey (2CW+2CCW) 10X5X3 (комплект)",
            "Камера: RunCam Phoenix 2 Special Edition 1500 TVL",
            "Відеопередавач: RushFpv TANK SOLO VTX 5,8 GHz, 2.5 W",
            "Антена: Foxeer Pagoda PRO 150 mm 5,8 Ghz RPSMA",
            "Радіоприймач: BetaFPV ELRS 900 RX 915 MHz"
        ],
        technicalSpecs: [
          { name: "Час польоту", value: "до 20 хв" },
          { name: "Рекомендована дальність", value: "До 10 км" },
          { name: "Максимальна дальність", value: "До 25 км" },
          { name: "Вантажопідйомність", value: "До 3 кг" },
          { name: "Частота зв’язку", value: "915 MHz" },
          { name: "Тип підключення", value: "ExpressLRS" },
        ...
        keyFeatures: [
          "Потужний FPV нічний бомбер",
          "Передові технології керування",
          "Висока автономність польоту",
          "Поворотна денна камера",
          "Надійна система зв’язку",
        ],
      },
      {
  ...
  reb: {
    title: "Системи РЕБ",
    description: "Мобільні платформи радіоелектронної боротьби",
    heroImage: "../image/product/bg-image-product.webp",
    items: [
      {
        title: "РЕБ Heavy",
      ...
      },
      {
        ...
        technicalSpecs: [
          ...
          { name: "Кількість діапазонів", value: "8" },
          { name: "Діапазони завад (МГц)", value: "300–1200, 1500, 2400, 5200, 5800" },
      ...
      },
      {
        ...
        technicalSpecs: [
          { name: "Режим роботи", value: "імпульсний" },
          { name: "Зона покриття", value: "500 м" },
          { name: "Кількість діапазонів", value: "10" },
          { name: "Діапазони завад (МГц)", value: "300–1200, 1500, 2400, 5200, 5800" },
          { name: "Живлення", value: "220В" },
          { name: "Вага", value: "до 25 кг" },
        ],
        keyFeatures: [
          "Режим імпульсної дії",
          "Розширена кількість діапазонів — 10",
          "Зона покриття до 500 м",
  ...
  skynetix2: {
    ...
    description: "Оновлена платформа дронів з покращеною батареєю",
    heroImage: "../image/product/bg-image-product.webp",
    items: [
      {
        title: "Skynetix 2 + АКБ",
